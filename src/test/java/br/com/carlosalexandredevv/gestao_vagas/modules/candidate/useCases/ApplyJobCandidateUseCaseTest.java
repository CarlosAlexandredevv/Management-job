package br.com.carlosalexandredevv.gestao_vagas.modules.candidate.useCases;
...
public class ApplyJobCandidateUseCaseTest {
    ...
    public void should_be_able_to_create_a_new_apply_job() {
        ...
        when(jobRepository.findById(idJob)).thenReturn(Optional.of(JobEntity.builder().build()));
